  ...
  return (
    <div className="w-full space-y-12">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-white">Important Warning</h2>
      ...
      <motion.div
        ...
        className="space-y-6 rounded-2xl border-2 border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-orange-500/10 p-8"
      >
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] p-6">
            <div className="w-8 h-8 rounded-lg bg-red-500/20 flex items-center justify-center flex-shrink-0">
              <X className="w-4 h-4 text-red-400" />
            </div>
            <div className="space-y-4">
              <p className="text-white font-medium">If you change it now:</p>
          ...
          <div className="flex items-start gap-4 rounded-xl border border-green-500/20 bg-green-500/10 p-6">
            ...
            <div className="space-y-4">
              <p className="text-white font-medium">The right way:</p>
        ...
        {/* Calendar */}
        <div className="space-y-4">
          <p className="text-sm text-[#b8c0cd]">Your calendar for the next week:</p>
          ...
          <p className="text-center text-xs text-[#525a6b]">Start today (marked in green)</p>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="space-y-4 rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.03)] p-6"
      >
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="rounded-lg bg-[rgba(255,255,255,0.04)] p-4 text-center">
            <p className="mb-1 text-xs text-[#525a6b]">Sensitivity</p>
        ...
        <p className="text-center text-sm text-[#525a6b]">
      ...
      >
        <motion.button
          ...
          className={`flex w-full items-center gap-4 rounded-xl border-2 p-6 transition-all ${
            agreed 
      ...
      >
        <motion.button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[rgba(255,255,255,0.06)] px-4 py-3 font-medium text-white transition-all hover:bg-[rgba(255,255,255,0.1)]"
        >
      ...
      >
        <button
          onClick={onBack}
          className="flex items-center gap-2 rounded-xl bg-[rgba(255,255,255,0.06)] px-4 py-3 font-medium text-white transition-all hover:bg-[rgba(255,255,255,0.1)]"
        >
        ...
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 px-5 py-3 font-medium text-white shadow-lg shadow-green-500/25 transition-all hover:shadow-green-500/40 disabled:cursor-not-allowed disabled:opacity-50"
        >
